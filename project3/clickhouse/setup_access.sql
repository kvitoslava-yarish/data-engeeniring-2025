...
CREATE USER IF NOT EXISTS analyst_limited_user IDENTIFIED BY 'lim123';
...
GRANT SELECT ON youtube_gold.snapshot_dim_channel  TO analyst_full;
GRANT SELECT ON youtube_gold.snapshot_dim_video     TO analyst_full;
...
GRANT SELECT ON youtube_gold.snapshot_dim_channel  TO analyst_limited;
GRANT SELECT ON youtube_gold.snapshot_dim_video     TO analyst_limited;
